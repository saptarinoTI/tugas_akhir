@extends('layout.app')
@section('main-title', 'Data Pendaftaran Seminar Hasil Mahasiswa')
@section('main-page')
    <div class="row row-deck row-cards">
        <div class="col-12">
            <div class="card">
                <div class="table-responsive text-muted">
                    <table id="table_seminarhasil" class="table card-table table-vcenter datatable" style="width: 100%;">
                        <thead>
                            <tr>
    ...
    @push('after-script')
        <script>
            ...
            $(function() {
                var table = $('#table_seminarhasil').DataTable({
                    processing: true,
                    serverSide: true,
                    responsive: true,
                    pageLength: 10,
