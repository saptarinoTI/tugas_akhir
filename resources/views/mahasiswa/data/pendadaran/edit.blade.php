  <form method="POST" action="{{ route('pendadaran.update', $pendadaran->id) }}" enctype="multipart/form-data">
      ...
      <div class="row">
          <div class="col-md-6">
              <div class="mb-2">
                  <label class="form-label">Lembar Aktifitas Tugas Akhir / Lembar
                      Konsultasi</label>
                  <a href="{{ Storage::url($pendadaran->lmbr_konsultasi) }}" target="_blank" rel="noopener noreferrer"
                      class="text-decoration-none fw-semibold text-muted-light">
                      <i class="ti ti-file-download" style="font-size: 18px;"></i> File
                  </a>
          ...
          <div class="col-md-6">
              <div class="mb-2">
                  ...
                  <a href="{{ Storage::url($pendadaran->bebas_perkuliahan) }}" target="_blank"
                      rel="noopener noreferrer" class="text-decoration-none fw-semibold text-muted-light">
                      <i class="ti ti-file-download" style="font-size: 18px;"></i> File
                  </a>
                  <input type="file" class="form-control @error('bebas_perkuliahan') is-invalid @enderror"
                      name="bebas_perkuliahan" />
                  <span class="small text-muted-light fw-semibold">* Upload file PDF maksimal 1
                      MB.</span>
      ...
      <div class="row">
          <div class="col-md-6">
              <div class="mb-2">
                  ...
                  <a href="{{ Storage::url($pendadaran->bebas_keuangan) }}" target="_blank" rel="noopener noreferrer"
                      class="text-decoration-none fw-semibold text-muted-light">
                      <i class="ti ti-file-download" style="font-size: 18px;"></i> File
                  </a>
          ...
          <div class="col-md-6">
              <div class="mb-2">
                  ...
                  <a href="{{ Storage::url($pendadaran->bebas_perpus) }}" target="_blank" rel="noopener noreferrer"
                      class="text-decoration-none fw-semibold text-muted-light">
                      <i class="ti ti-file-download" style="font-size: 18px;"></i> File
                  </a>
                  <input type="file" class="form-control @error('bebas_perpus') is-invalid @enderror"
                      name="bebas_perpus" />
                  <span class="small text-muted-light fw-semibold">* Upload file PDF maksimal 1
                      MB.</span>
                  @error('bebas_perpus')
      ...
      <div class="row">
          <div class="col-md-6">
              <div class="mb-2">
                  ...
                  <a href="{{ Storage::url($pendadaran->bebas_lab) }}" target="_blank" rel="noopener noreferrer"
                      class="text-decoration-none fw-semibold text-muted-light">
                      <i class="ti ti-file-download" style="font-size: 18px;"></i> File
                  </a>
          ...
          <div class="col-md-6">
              <div class="mb-2">
                  ...
                  <a href="{{ Storage::url($pendadaran->act_program) }}" target="_blank" rel="noopener noreferrer"
                      class="text-decoration-none fw-semibold text-muted-light">
                      <i class="ti ti-file-download" style="font-size: 18px;"></i> File
                  </a>
                  <input type="file" class="form-control @error('act_program') is-invalid @enderror"
                      name="act_program" />
                  <span class="small text-muted-light fw-semibold">* Upload file PDF maksimal 1
                      MB.</span>
                  @error('act_program')
      ...
      <div class="row">
          <div class="col-md-6">
              <div class="mb-2">
                  ...
                  <a href="{{ Storage::url($pendadaran->komp_lab) }}" target="_blank" rel="noopener noreferrer"
                      class="text-decoration-none fw-semibold text-muted-light">
                      <i class="ti ti-file-download" style="font-size: 18px;"></i> File
                  </a>
      ...
      <div class="row">
          <div class="col-md-6">
              <div class="mb-2">
                  ...
                  <a href="{{ Storage::url($pendadaran->ijazah_terakhir) }}" target="_blank"
                      rel="noopener noreferrer" class="text-decoration-none fw-semibold text-muted-light">
                      <i class="ti ti-file-download" style="font-size: 18px;"></i> File
                  </a>
      ...
      <div class="row">
          <div class="col-md-6">
              <div class="mb-2">
                  ...
                  <a href="{{ Storage::url($pendadaran->akte_kelahiran) }}" target="_blank" rel="noopener noreferrer"
                      class="text-decoration-none fw-semibold text-muted-light">
                      <i class="ti ti-file-download" style="font-size: 18px;"></i> File
                  </a>
      ...
      <div class="mb-2">
          ...
          <textarea name="judul_ta" rows="3" class="form-control @error('judul_ta') is-invalid @enderror"
              required>{{ $pendadaran->judul_ta }}</textarea>
          @error('judul_ta')
              <div class="invalid-feedback">
                  {{ $message }}
              </div>
