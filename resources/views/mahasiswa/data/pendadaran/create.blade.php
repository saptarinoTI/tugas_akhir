  ...
  <div class="col-12">
    ...
    <div class="card">
      <div class="d-flex justify-content-between">
        <h5 class="card-header">Pendataran Pendadaran Tugas Akhir Mahasiswa</h5>
      </div>
      <div class="card-body">
        <form method="POST" action="{{ route('pendadaran.store') }}" enctype="multipart/form-data">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="mb-3">
                ...
                <input type="text" class="form-control @error('nama') is-invalid @enderror" name="nama" value="{{ strtoupper($proposal->mahasiswa->nama) }}" readonly required />
                @error('nama')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="mb-3">
                ...
                <input type="text" class="form-control @error('ttl') is-invalid @enderror" name="ttl" value="{{ strtoupper($proposal->mahasiswa->tpt_lahir) }}, {{ date('d F Y', strtotime($proposal->mahasiswa->tgl_lahir)) }}" readonly required />
                @error('ttl')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
          ...
          <div class="mb-3">
            ...
            <textarea class="form-control" name="alamat" id="alamat" rows="2" required readonly>{{ strtoupper($proposal->mahasiswa->alamat) }}</textarea>
          </div>
          <div class="row">
            <div class="col-md-6">
              <div class="mb-3">
                <label class="form-label">Nama Pembimbing Utama</label>
                <input type="text" class="form-control @error('dosen_id_satu') is-invalid @enderror" name="dosen_id_satu" value="{{ strtoupper($proposal->dosen_satu->nama) }}" readonly required />
                @error('dosen_id_satu')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
            ...
            <div class="col-md-6">
              <div class="mb-3">
                ...
                <input type="text" class="form-control @error('dosen_id_dua') is-invalid @enderror" name="dosen_id_dua" value="{{ strtoupper($proposal->dosen_dua->nama) }}" readonly required />
                @error('dosen_id_dua')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="mb-2">
                ...
                <input type="file" class="form-control @error('bebas_perkuliahan') is-invalid @enderror" name="bebas_perkuliahan" required />
                <span class="small text-muted-light fw-semibold">* Upload file PDF maksimal 1 MB.</span>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="mb-2">
                ...
                <input type="file" class="form-control @error('bebas_keuangan') is-invalid @enderror" name="bebas_keuangan" required />
                <span class="small text-muted-light fw-semibold">* Upload file PDF maksimal 1
                  MB.</span>
            ...
            <div class="col-md-6">
              <div class="mb-2">
                ...
                <input type="file" class="form-control @error('bebas_perpus') is-invalid @enderror" name="bebas_perpus" required />
                <span class="small text-muted-light fw-semibold">* Upload file PDF maksimal 1
                  MB.</span>
                @error('bebas_perpus')
                <div class="invalid-feedback">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="mb-2">
                ...
                <input type="file" class="form-control @error('bebas_lab') is-invalid @enderror" name="bebas_lab" required />
                <span class="small text-muted-light fw-semibold">* Upload file PDF maksimal 1
                  MB.</span>
                @error('bebas_lab')
                <div class="invalid-feedback">
            ...
            <div class="col-md-6">
              <div class="mb-2">
                ...
                <input type="file" class="form-control @error('act_program') is-invalid @enderror" name="act_program" required />
                <span class="small text-muted-light fw-semibold">* Upload file PDF maksimal 1
                  MB.</span>
                @error('act_program')
                <div class="invalid-feedback">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="mb-2">
                ...
                <input type="file" class="form-control @error('komp_lab') is-invalid @enderror" name="komp_lab" required />
                <span class="small text-muted-light fw-semibold">* Upload file PDF maksimal 1
                  MB.</span>
                @error('komp_lab')
                <div class="invalid-feedback">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="mb-2">
                ...
                <input type="file" class="form-control @error('ijazah_terakhir') is-invalid @enderror" name="ijazah_terakhir" required />
                <span class="small text-muted-light fw-semibold">* Upload file PDF maksimal 1
                  MB.</span>
          ...
          <div class="mb-2">
            ...
            <textarea name="judul_ta" rows="3" class="form-control @error('judul_ta') is-invalid @enderror" required>{{ old('judul_ta') }}</textarea>
            @error('judul_ta')
            <div class="invalid-feedback">
              {{ $message }}
            </div>
