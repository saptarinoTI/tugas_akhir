<div class="table-responsive-lg">
    <table class="table app-table-hover mb-0 text-left">
        ...
        <tr>
            ...
            <th>:</th>
            <td class="text-dark fw-semibold">
                {{ ucwords($seminar->mahasiswa->nama) }}
            </td>
        </tr>
        ...
        <tr>
            ...
            <th>:</th>
            <td class="text-dark fw-semibold"><a href="{{ Storage::url($seminar->krs) }}" target="_blank"
                    rel="noopener noreferrer" class="btn btn-sm btn-primary border-0 rounded-2">Unduh</a></td>
        </tr>

        <tr>
            <th class="col-4">Transkip Nilai</th>
            <th>:</th>
            <td class="text-dark fw-semibold"><a href="{{ Storage::url($seminar->transkip_nilai) }}" target="_blank"
                    rel="noopener noreferrer" class="btn btn-sm btn-primary border-0 rounded-2">Unduh</a></td>
        </tr>
        ...
        <tr>
            ...
            <th>:</th>
            <td class="text-dark fw-semibold"><a href="{{ Storage::url($seminar->laporan_kp) }}" target="_blank"
                    rel="noopener noreferrer" class="btn btn-sm btn-primary border-0 rounded-2">Unduh</a></td>
        </tr>
        ...
        <tr>
            ...
            <th>:</th>
            <td class="text-dark fw-semibold"><a href="{{ Storage::url($seminar->kartu_kuning) }}" target="_blank"
                    rel="noopener noreferrer" class="btn btn-sm btn-primary border-0 rounded-2">Unduh</a></td>
        </tr>
        ...
        <tr>
            ...
            <th>:</th>
            <td class="text-dark fw-semibold"><a href="{{ Storage::url($seminar->sk_keuangan) }}" target="_blank"
                    rel="noopener noreferrer" class="btn btn-sm btn-primary border-0 rounded-2">Unduh</a></td>
        </tr>
        ...
        <tr>
            ...
            <th>:</th>
            <td class="text-dark fw-semibold"><a href="{{ Storage::url($seminar->lmbr_konsultasi) }}" target="_blank"
                    rel="noopener noreferrer" class="btn btn-sm btn-primary border-0 rounded-2">Unduh</a></td>
        </tr>
