  ...
  <div class="col-12">
    ...
    <div class="card">
      <div class="d-flex justify-content-between">
        <h5 class="card-header">Ajuan Proposal Tugas Akhir Mahasiswa</h5>
      </div>
      <div class="card-body">
        <form method="POST" action="{{ route('proposal.store') }}" enctype="multipart/form-data">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="mb-3">
                ...
                <input type="text" class="form-control @error('id') is-invalid @enderror" name="id" value="{{ date('Y') . $mahasiswa->nim }}" readonly />
                @error('id')
            ...
            <div class="col-md-6">
              <div class="mb-3">
                ...
                <input type="text" class="form-control @error('nim') is-invalid @enderror" name="nim" value="{{ $mahasiswa->nim }}" readonly />
                @error('nim')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
          ...
          <div class="mb-2">
            ...
            <input type="file" class="form-control @error('file_satu') is-invalid @enderror" name="file_satu" required />
          ...
          <div class="mb-2">
            ...
            <input type="text" class="form-control @error('judul_satu') is-invalid @enderror" name="judul_satu" required autocomplete="off" value="{{ old('judul_satu') }}" />
            @error('judul_satu')
            <div class="invalid-feedback">
              {{ $message }}
            </div>
          ...
          <div class="mb-2">
            ...
            <input type="text" class="form-control @error('judul_dua') is-invalid @enderror" name="judul_dua" autocomplete="off" value="{{ old('judul_dua') }}" />
            @error('judul_dua')
            <div class="invalid-feedback">
              {{ $message }}
            </div>
          ...
          <div class="mb-2">
            ...
            <input type="text" class="form-control @error('judul_tiga') is-invalid @enderror" name="judul_tiga" autocomplete="off" value="{{ old('judul_tiga') }}" />
            @error('judul_tiga')
            <div class="invalid-feedback">
              {{ $message }}
            </div>
