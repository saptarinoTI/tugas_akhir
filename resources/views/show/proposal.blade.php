<div class="table-responsive-lg">
  <table class="table app-table-hover my-0 text-left">
    ...
    <tr>
      ...
      <th>:</th>
      <td>
        <a href="storage/{{ $proposal->file_satu }}" target="_blank" class="text-decoration-none text-dark fw-bolder">{{ ucwords($proposal->judul_satu) }} - <i class='bx bxs-download'></i></a>
      </td>
    </tr>
    @endif
    ...
    <tr>
      ...
      <th>:</th>
      <td>
        <a href="storage/{{ $proposal->file_dua }}" target="_blank" class="text-decoration-none text-dark fw-bolder">{{ ucwords($proposal->judul_dua) }} - <i class='bx bxs-download'></i></a>
      </td>
    </tr>
    @endif
    ...
    <tr>
      ...
      <th>:</th>
      <td>
        <a href="storage/{{ $proposal->file_tiga }}" target="_blank" class="text-decoration-none text-dark fw-bolder">{{ ucwords($proposal->judul_tiga) }} -
