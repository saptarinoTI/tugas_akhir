...
class ProposalController extends Controller
{
    ...
    public function create()
    {
        $nim = Auth::user()->id;
        $mahasiswa = Mahasiswa::where('nim', '=', $nim)->first();
        return view('mahasiswa.data.proposalta.create', compact('mahasiswa'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($result) {
            Alert::success('Ajuan proposal tugas akhir berhasil.');
    ...
    {
        $proposal = ProposalTA::findOrFail($id);
        return view('mahasiswa.data.proposalta.edit', compact('proposal'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $result = $proposal->save();
        if ($result) {
            Alert::success('Ajuan proposal tugas akhir berhasil dirubah.');
            return redirect()->route('proposal.index');
        }
    }
}
