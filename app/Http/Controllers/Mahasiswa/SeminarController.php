...
class SeminarController extends Controller
{
    ...
    public function index()
    {
        ...
        if ($proposal) {
            ...
            if ($statusProposalSelesai || $statusProposalDiterima || $statusProposalPerbaikan) {
                ...
                Alert::warning('Selesaikan proposal tugas akhir terlebih dahulu!');
    ...
    public function create()
    {
        ...
        $proposal = ProposalTA::where('mahasiswa_nim', '=', $nim)->first();
        $noSeminar = date('Y') . $nim;
        return view('mahasiswa.data.seminarhasil.create', compact('proposal', 'noSeminar'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $seminar_hasil->judul_ta = strtolower(htmlspecialchars($request->judul_ta));
        $seminar_hasil->keterangan = "silahkan bertemu prodi, untuk memberikan berkas tugas akhir yang sudah disetujui oleh dosen pembimbing. sebanyak 1 rangkap asli + 3 rangkap fotocopy.";
    ...
    {
        $seminar = SeminarHasil::findOrFail($id);
        return view('mahasiswa.data.seminarhasil.edit', compact('seminar'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $seminar->judul_ta = strtolower(htmlspecialchars($request->judul_ta));
        $seminar->status = 'dikirim';
        $seminar->keterangan = 'silahkan bertemu bagian prodi teknik informatika untuk memberikan berkas tugas akhir yang sudah disetujui oleh dosen pembimbing. sebanyak 1 rangkap asli + 3 rangkap fotocopy.';
