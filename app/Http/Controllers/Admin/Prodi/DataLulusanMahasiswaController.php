...
class DataLulusanMahasiswaController extends Controller
{
    ...
    public function getData()
    {
        ...
        return DataTables::of($lulus)
            ...
            ->addColumn('aksi', function ($row) {
                return '<a href="#modal" data-remote="' . route('mahasiswa-lulusan.show', $row->id) . '" data-bs-toggle="modal" data-bs-target="#modal" data-title="Detail Lulusan Mahasiswa Teknik Informatika" class="my-1 btn btn-sm py-2 border-0 rounded-2 btn-info"><i class="bx bx-info-circle"></i></a>';
            })
